...
public class TestController {
	...
	@RequestMapping(value = "/jsp01", method = RequestMethod.GET)
	public String jsp01(Locale locale, Model model) {
	...
	public String test001(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public String test002(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public String test003(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
